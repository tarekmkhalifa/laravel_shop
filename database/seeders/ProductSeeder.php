    ...
    public function run()
    {
        $products = [
            [
                ...
                'name'=>'Samsung Galaxy A23 Dual SIM 128GB',
                'details'=>'Samsung Galaxy A23 Dual SIM, 128GB, 6GB RAM, 4G LTE - Orange',
                'description'=>"Take in more, all at once. The Galaxy A23's 6.6-inch TFT V-Cut Display gives you room to see and do more. With FHD+ technology and a 90Hz refresh rate, the content you see every day will look smoother and sharper.",
                'brand'=>'Samsung',
                'price'=>310,
                'shipping_cost'=>25,
